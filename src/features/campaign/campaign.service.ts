...
export class CampaignService {
    ...
    6. Use ONLY HTML tags: <div>, <p>, <strong>, <em>, <ul>, <li>, <a>
    7. Every paragraph must be wrapped in <p> tags
    8. Use <strong> for important points
  `;
		...
		const completion = await this.openai.chat.completions.create({
			...
			messages: [
				{
					role: "system",
					content: `You are an expert email copywriter with deep knowledge of marketing frameworks and psychology.
        ALWAYS return content in valid HTML format.
		...
		// Wrap any unwrapped text in <p> tags
